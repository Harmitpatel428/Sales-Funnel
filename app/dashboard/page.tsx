          ...
          <button 
            onClick={() => {
              const testLead: Lead = {
                id: crypto.randomUUID(),
                kva: 'Test KVA',
                connectionDate: '', // Test lead with no connection date
                consumerNumber: '123-456-7890',
              ...
              console.log('Adding test lead:', testLead);
              addLead(testLead);
              console.log('Test lead added, current leads count:', leads.length);
            }}
